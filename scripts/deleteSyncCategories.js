...
async function syncCategories() {
  try {
    ...
    try {
      ...
      // First delete all child categories (those with parentCategoryId not null)
      ...
      // Then delete all parent categories
      await prisma.category.deleteMany({
        where: {
      ...
      console.log('All existing categories deleted successfully.');
    } catch (deleteError) {
